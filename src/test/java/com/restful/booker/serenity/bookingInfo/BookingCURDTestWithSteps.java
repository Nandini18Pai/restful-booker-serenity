...
public class BookingCURDTestWithSteps extends TestBase {
    static String firstName = "Cheema" + TestUtils.getRandomValue();
    static String updateFirstName = "Update" + TestUtils.getRandomValue();
    static String lastName = "Kelly" + TestUtils.getRandomValue();
    ...
    public void test002() {
        ...
        bookingId = bookingSteps.creatingBooking(firstName,lastName,150, true, additionalNeeds);
    ...
    @Test
    public void test003() {
        String updatedFirstNameResult =  bookingSteps.updatingBooking(updateFirstName,lastName,150,true,additionalNeeds, token, bookingId);
